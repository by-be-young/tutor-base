<!-- src/components/admin/AnswerPanel.vue -->
<template>
    <div>
        <h2 class="admin-title">答案设置</h2>
...
const activeFilter = ref('unset')

const filters = [
    { value: 'unset', label: '待设置' },
    { value: 'set', label: '已设置' },
...
function handleFileClick(blogId) {
    router.push(`/blog/${blogId}?mode=answer`)
}
